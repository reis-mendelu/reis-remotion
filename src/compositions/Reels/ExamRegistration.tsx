...
// --- TIMELINE (310 frames = ~10.3s @ 30fps) ---
// 0-20:    Panel springs in
// 10-40:   KineticText "Přihlas se ke zkoušce →"
// 40-80:   Card expands
// 100:     Term highlight (cursor)
// 112:     Spinner
// 154:     Registered — badge + details appear
// 154-210: Linger on registered state
// 195-210: Panel fades out
// 210-310: BrandedEndSlide

const PANEL_FADE_START = 195;
const END_CARD_START = 210;
